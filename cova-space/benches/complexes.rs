...
fn bench_complexes(c: &mut Criterion) {
  ...
  group.bench_function("simplicial_complex_instantiation", |b| {
    b.iter(|| {
  ...
  group.bench_function("cubical_complex_instantiation", |b| {
    b.iter(|| {
  ...
  group.bench_function("simplicial_homology_computation", |b| {
    b.iter(|| {
...
fn bench_complexes_large(c: &mut Criterion) {
  ...
  group.bench_function("simplicial_build_surface", |b| {
    b.iter(|| {
      let mut complex = SimplicialComplex::new();
  ...
  group.bench_function("simplicial_homology_4simplex", |b| {
    b.iter(|| {
